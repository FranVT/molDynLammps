...
export chi_4o=0.05           # Initial Crosslinker concentration
export chi_4f=0.05           # Final Crosslinker concentration
export chi_4delta=0.01       # Delta of Crosslinker concentration
