...
The methodology used for this graphs is by selecting random points inside the simulation box and start increasing the radius of a sphere until it collides with a patchy particle.
