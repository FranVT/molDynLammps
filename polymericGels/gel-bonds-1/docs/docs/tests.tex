...
\begin{align*}
    \vec{F}_{i} &= -\nabla U_\mathrm{swap}\qty(r_{ij},r_{ik}) \\
            ...
            &= -\alpha\left[ U_3(r_{ik})\pdv{r}U_3(r_{ij}) + U_3(r_{ij})\pdv{r}U_3(r_{ik}) \right] 
\end{align*}
} para la fuerza de cada partículs:

\begin{align*}
    \vec{F}_{i} &= -\alpha\left[ U_3(r_{ik})\pdv{r}U_3(r_{ij}) + U_3(r_{ij})\pdv{r}U_3(r_{ik}) \right] \\
    \vec{F}_{j} &=  -\alpha\left[ U_3(r_{jk})\pdv{r}U_3(r_{ij}) + U_3(r_{ij})\pdv{r}U_3(r_{jk}) \right] \\
    \vec{F}_{k} &= -\alpha\left[ U_3(r_{jk})\pdv{r}U_3(r_{ik}) + U_3(r_{ik})\pdv{r}U_3(r_{jk}) \right]
\end{align*}
