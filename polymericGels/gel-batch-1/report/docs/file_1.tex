...
\begin{figure}[ht!]
    \centering
    \includegraphics{../Figures/NEW_fig_Sq_phi_series_loglog_time_initial_final.png}
    \caption{
...
\paragraph{Loglog scales} The interpretation changes a little bit for this visualization.

\begin{figure}[ht!]
    \centering
    \includegraphics{../Figures/NEW_fig_Sq_phi_series__semilog_loglog_time_final.png}
    \caption{
        Comparisson of the structure factor for systems with different packing fractions.
        Grey area represent the large length scale, the blue area represent the intermediate length scale and the red area represent the small length scale.
        Top pannel is the initial configuration.
...
\begin{figure}[ht!]
    \centering
    \includegraphics{../Figures/fig_pore_histogram_phiseries0.010.050.051.0500000.09.5e6_time_initial_final.png}
    \caption{
