...
f_patch12=zeros(length(dist_12));#map(r->last(forcePatch(1.0,0.4,r)),dist_12);
f_patch13=zeros(length(dist_12));#map(r->last(forcePatch(1.0,0.4,r)),dist_13);
f_patch23=zeros(length(dist_12));#map(r->last(forcePatch(1.0,0.4,r)),dist_23);
...
df_1x = abs.(f_part1[:,1] .- DATA_dump_1.fx)./abs.(f_part1[:,1]);
df_1y = abs.(f_part1[:,2] .- DATA_dump_1.fy)./abs.(f_part1[:,2]);

df_2x = abs.(f_part2[:,1] .- DATA_dump_2.fx)./abs.(f_part2[:,1]);
df_2y = abs.(f_part2[:,2] .- DATA_dump_2.fy)./abs.(f_part2[:,2]);

df_3x = abs.(f_part3[:,1] .- DATA_dump_3.fx)./abs.(f_part3[:,1]);
df_3y = abs.(f_part3[:,2] .- DATA_dump_3.fy)./abs.(f_part3[:,2]);
...
fig_TabTeo=Figure(size=(18.75cm,18.75cm));
ax1=Axis(fig_TabTeo[1,1],
             title=latexstring("\\vec{F}_{\\mathrm{Tab~patch}~1}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
...
ax2=Axis(fig_TabTeo[2,1],
             title=latexstring("\\vec{F}_{\\mathrm{Tab~patch}~2}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax3=Axis(fig_TabTeo[3,1],
             title=latexstring("\\vec{F}_{\\mathrm{Tab~patch}~3}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax4=Axis(fig_TabTeo[1,2],
             title=latexstring("\\vec{F}_{\\mathrm{Teo~patch}~1}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax5=Axis(fig_TabTeo[2,2],
             title=latexstring("\\vec{F}_{\\mathrm{Teo~patch}~2}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax6=Axis(fig_TabTeo[3,2],
             title=latexstring("\\vec{F}_{\\mathrm{Teo~patch}~3}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax7=Axis(fig_TabTeo[1,3],
             title=latexstring("\\vec{F}_{\\mathrm{LAMMPS~patch}~1}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax8=Axis(fig_TabTeo[2,3],
             title=latexstring("\\vec{F}_{\\mathrm{LAMMPS~patch}~2}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax9=Axis(fig_TabTeo[3,3],
             title=latexstring("\\vec{F}_{\\mathrm{LAMMPS~patch}~3}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
linkyaxes!(ax1, ax2, ax3, ax4, ax5, ax6, ax7, ax8, ax9) #, ax3_F, ax1_Fa, ax2_Fa, ax3_Fa)
...
lines!(ax4,time_dump,f_part1[:,1],
        color=1,
        colormap=:tab10,
        colorrange=(1,10)
       )
lines!(ax4,time_dump,f_part1[:,2],
        color=1,
        colormap=:tab10,
        colorrange=(1,10),
        linestyle=:dash
...
lines!(ax5,time_dump,f_part2[:,1],
        color=2,
        colormap=:tab10,
        colorrange=(1,10)
       )
lines!(ax5,time_dump,f_part2[:,2],
        color=2,
        colormap=:tab10,
        colorrange=(1,10),
        linestyle=:dash
...
lines!(ax6,time_dump,f_part3[:,1],
        color=3,
        colormap=:tab10,
        colorrange=(1,10)
       )
lines!(ax6,time_dump,f_part3[:,2],
        color=3,
        colormap=:tab10,
        colorrange=(1,10),
        linestyle=:dash
...
lines!(ax7,time_dump,DATA_dump_1.fx,
        color=1,
        colormap=:tab10,
        colorrange=(1,10)
       )
lines!(ax7,time_dump,DATA_dump_1.fy,
        color=1,
        colormap=:tab10,
        colorrange=(1,10),
        linestyle=:dash
...
lines!(ax8,time_dump,DATA_dump_2.fx,
        color=2,
        colormap=:tab10,
        colorrange=(1,10)
       )
lines!(ax8,time_dump,DATA_dump_2.fy,
        color=2,
        colormap=:tab10,
        colorrange=(1,10),
        linestyle=:dash
...
lines!(ax9,time_dump,DATA_dump_3.fx,
        color=3,
        colormap=:tab10,
        colorrange=(1,10)
       )
lines!(ax9,time_dump,DATA_dump_3.fy,
        color=3,
        colormap=:tab10,
        colorrange=(1,10),
        linestyle=:dash
...
save("fig_FTabTeo.png", fig_TabTeo, px_per_unit = 300/inch)

fig_FswapDiff=Figure(size=(18.75cm,18.75cm));
ax1=Axis(fig_FswapDiff[1,1],
             title=latexstring("\\vec{F}_{\\mathrm{Teo~patch}~1} - \\vec{F}_{\\mathrm{LAMMPS~patch}~1}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax2=Axis(fig_FswapDiff[2,1],
             title=latexstring("\\vec{F}_{\\mathrm{Teo~patch}~2} - \\vec{F}_{\\mathrm{LAMMPS~patch}~2}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
ax3=Axis(fig_FswapDiff[3,1],
             title=latexstring("\\vec{F}_{\\mathrm{Teo~patch}~3} - \\vec{F}_{\\mathrm{LAMMPS~patch}~3}"),
             xlabel=L"t~[\tau]",
             ylabel=L"F~[N^*]",
             titlesize=tl_sz,
             xticklabelsize=ot_sz,
...
scatterlines!(ax1_eng,time_fix,DATA_fix.c_tablePair,label=L"U_{\mathrm{patch}}+U_{\mathrm{swap}}",color=2,colormap=:tab10,colorrange=(1,10),markersize=1.5)
...
scatter!(ax2_eng,time_fix,DATA_fix.c_tablePair,label=L"U_{\mathrm{patch}}+U_{\mathrm{swap}}",color=2,colormap=:tab10,colorrange=(1,10))
